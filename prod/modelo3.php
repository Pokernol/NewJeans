            ...
            <table class="table table-borderless blockquote text-left">
                <tbody>
                    <tr>
                        <th scope="row">
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active"><img class="d-block w-100" src="../imagens/stars2.png" alt="Primeiro Slide"></div>
                                    <div class="carousel-item"><img class="d-block w-100" src="../imagens/stars1.png" alt="Segundo Slide"></div>
                                    <div class="carousel-item"><img class="d-block w-100" src="../imagens/stars3.png" alt="Terceiro Slide"></div>
                                </div>
                        ...
                        <!--- > FORMULARIO <-->
                        <td>
                            <form method="post" action="modelo3.php">
                                <div>
                                    <input type="hidden" name="img" value="../imagens/moletom1(1).png">
                                    <input type="hidden" name="produto" value="Jaqueta Fleece Shooting Stars">
                                    <h4 class="mb-3">Jaqueta Fleece Shooting Stars</h4>
                                    <input type="hidden" name="preco" value="200.00">
                                    <p class="preço mx-3">R$200,00</p>
                                </div>
