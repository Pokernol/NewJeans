                    ...
                    <tr>
                        <th scope="row">
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active"><img class="d-block w-100" src="../imagens/modelo06_01.png" alt="Primeiro Slide"></div>
                                    <div class="carousel-item"><img class="d-block w-100" src="../imagens/modelo06_02.png" alt="Segundo Slide"></div>
                                    <div class="carousel-item"><img class="d-block w-100" src="../imagens/modelo06_03.png" alt="Terceiro Slide"></div>
                                </div>
                        ...
                        <td>
                            <form method="post" action="">
                                <div>
                                    <input type="hidden" name="img" value="../imagens/modelo06_01.png">
                                    <input type="hidden" name="produto" value="Jaqueta Streetwear TALISHKO">
                                    <h4 class="mb-3">Jaqueta Streetwear TALISHKO</h4>
                                    <input type="hidden" name="preco" value="250.00">
                                    <p class="preço mx-3">R$250,00</p>
                                </div>
