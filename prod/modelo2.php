            ...
            <table class="table table-borderless blockquote text-left">
                <tbody>
                    <tr>
                        <th scope="row">
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active"><img class="d-block w-100" src="../imagens/tubarao3.png" alt="Primeiro Slide"></div>
                                    <div class="carousel-item"><img class="d-block w-100" src="../imagens/tubarao1.png" alt="Segundo Slide"></div>
                                    <div class="carousel-item"><img class="d-block w-100" src="../imagens/tubarao2.png" alt="Terceiro Slide"></div>
                                </div>
                        ...
                        <!--- > FORMULARIO <-->
                        <td>
                            <form method="post" action="modelo2.php">
                                <div>
                                    <input type="hidden" name="img" value="../imagens/sueter2.png">
                                    <input type="hidden" name="produto" value="Suéter TALISHKO Vintage Tubarão">
                                    <h4 class="mb-3">Suéter TALISHKO Vintage Tubarão</h4>
                                    <input type="hidden" name="preco" value="150.00">
                                    <p class="preço mx-3">R$150,00</p>
                                </div>
                                <div>
