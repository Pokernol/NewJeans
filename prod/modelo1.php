...
<body>
    ...
    <div>
        ...
        <!-- imagens produto-- > <-->
        <div class="container">
            <table class="table table-borderless blockquote text-left mt-3">
                <tbody>
                    <tr>
                        <th scope="row">
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active"><img class="d-block w-100"
                                            src="../imagens/ex1.jpg" alt="Primeiro Slide"></div>
                                    <div class="carousel-item"><img class="d-block w-80" src="../imagens/ex2.png"
                                            alt="Segundo Slide"></div>
                                    <div class="carousel-item"><img class="d-block w-100" src="../imagens/ex3.png"
                                            alt="Terceiro Slide"></div>
                                </div>
                        ...
                        <!--- > FORMULARIO <-->
                        <td>
                            <form method="post" action="modelo1.php">
                                <div>
                                    <input type="hidden" name="img" value="../imagens/moletom1.png">
                                    <input type="hidden" name="produto" value="Suéter PatoAelfric Eden Wow">
                                    <h4 class="mb-3">Suéter PatoAelfric Eden Wow</h4>
                                    <input type="hidden" name="preco" value="123.00">
                                    <p class="preço mx-3">R$123,00</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <input class="form-check-input" type="radio" value="Vermelho" name="cor">
                                        <label class="form-check-label h6">Vermelho</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="Cinza" name="cor">
                                        <label class="form-check-label h6">Cinza</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="Amarelo" name="cor">
                                        <label class="form-check-label h6">Amarelo</label>
                                    </div></br></br>
                                </div>
                                ...
                                <div class="form-group"></br>
                                    ...
                                    <input class="col-3 form-control" type="number" min="1" class="form-control"
                                        name="qtdade">
                                </div></br>
