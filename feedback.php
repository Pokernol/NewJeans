...
<body>
    ...
    <div>
        <div class="container-fluid blockquote text-center mt-3">
            <h1 class="h1-secundario text-dark">Feedback</h1>
        </div></br>

        <div class="container-fluid blockquote text-center">
            <p class="titulo-secundario">SEU CONTATO É MUITO IMPORTANTE PARA NÓS</p>
            <p class="texto-secundario">Envie-nos um e-mail preenchendo os campos abaixo para recebermos o seu feedback.
            </p>
        </div></br>
        ...
        <form class="col-6 container">
            ...
            <div class="form-group">
                <label for="exampleFormControlTextarea1">Descrição (Descreva aqui, detalhadamente seu feedback )</label>
